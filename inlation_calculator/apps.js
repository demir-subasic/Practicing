...
removeFromCart = (element) => {
   ...
   let products = document.querySelectorAll(".single-item");
    ...
    //Uklanjamo ceo red onoga sto smo dodali
    mainEl.remove();
    ...
    products.forEach(function(product) {
        let itemName = product.querySelector('.si-content h3').textContent;
      if(itemName === name) {
        ...
        product.querySelector(".actions button").textContent = "Dodaj";
      }
    })
}
